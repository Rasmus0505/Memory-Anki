...
def create_runtime_home(root: Path) -> Path:
    home = root / "runtime"
    database = home / "学习数据" / "memory_palace.db"
    ...
    with sqlite3.connect(database) as connection:
        ...
        connection.commit()
    attachment = home / "学科附件" / "example.txt"
