...
import { recordPalaceQuizChoiceAttemptApi, requestPalaceShortAnswerFeedbackApi } from '@/entities/quiz/api'
import { emitQuizResultFeedback } from '@/entities/quiz/model/quizResultFeedback'
import type { QuizRuntimeState } from '@/entities/quiz/model/quizRuntime'
