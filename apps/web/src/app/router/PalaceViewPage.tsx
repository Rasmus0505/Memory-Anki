...
import { buildAttachmentUrl, getPalaceEditorApi } from '@/shared/api/modules/palaces/catalogApi'
import { savePalaceEditorApi } from '@/shared/api/modules/palaces/editorApi'
