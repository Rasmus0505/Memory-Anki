...
describe('FreestyleFeedPager', () => {
  it('shows the same three buttons on PWA and desktop', () => {
    renderPager()
    ...
    expect(screen.queryByRole('button', { name: '跳过本组' })).toBeNull()
  })
  ...
  it('keeps card paging labels and does not revive palace jump buttons', () => {
    renderPager()
