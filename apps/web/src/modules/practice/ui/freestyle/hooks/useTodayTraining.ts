...
import { isQuizCard, stringListsEqual } from '@/modules/practice/ui/freestyle/model/freestyle-cards'
import { canCompleteRound as domainCanCompleteRound, clampTrainingIndex, freestyleTrainingMachine } from '@/modules/practice/public'
