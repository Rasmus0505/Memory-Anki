...
import EnglishWorkspacePage from '@/modules/english/ui/english/EnglishWorkspacePage'
...
vi.mock('@/modules/english/ui/english/components/EnglishGenerationLogDialog', () => ({
