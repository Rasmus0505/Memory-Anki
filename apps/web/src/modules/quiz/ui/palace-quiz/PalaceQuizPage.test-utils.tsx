...
import PalaceQuizPage from '@/modules/quiz/ui/palace-quiz/PalaceQuizPage'
...
vi.mock('@/modules/quiz/ui/palace-quiz/api', async (importOriginal) => ({
  ...(await importOriginal<typeof import('@/modules/quiz/ui/palace-quiz/api')>()),
