...
import type { QuizGenerationHistoryItem } from '@/modules/quiz/ui/palace-quiz/quiz-generation-history'
import { QUIZ_GENERATION_SOURCE_LABELS } from '@/modules/quiz/ui/palace-quiz/quiz-generation-history'
