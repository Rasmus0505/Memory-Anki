import { ChapterRangeTree } from '@/modules/quiz/ui/palace-quiz/components/palaceQuizCards'
import type { SubjectTreePayload } from '@/modules/quiz/ui/palace-quiz/model/palaceQuizPage'
