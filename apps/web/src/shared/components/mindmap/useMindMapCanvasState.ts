...
export function useMindMapCanvasState(
  ...
  }, [draggingNodeIdRef, handleFinishEdit, isDraggingNode, nodes, onAddChild, onDelete, previewLayout, previewState, readonly, selectedNodeId, viewport.handleNodeMeasure])
