...
describe('routeManifest 行为快照（与统一前的四处实现对拍）', () => {
  it.each([
    ...
    ['/freestyle/session', 'freestyle', 'freestyle', 'freestyle'],
    ...
    ['/english-reading', 'english', 'english', 'english:reading'],
    ...
    ['/palaces/42/practice', 'freestyle', 'palaces', 'palace:practice:42'],
    ['/segments/7/practice', 'freestyle', 'palaces', 'segment:practice:7'],
