...
import type { PalaceImportFooterModel } from '@/features/palace-edit/components/palace-import-drawer/types'
import { Button } from '@/shared/components/ui/button'

interface PalaceImportFooterProps {
  model: PalaceImportFooterModel
  copied: boolean
  onCopyText: () => Promise<void>
}

export function PalaceImportFooter({ model, copied, onCopyText }: PalaceImportFooterProps) {
  const {
    onClose,
    mode,
    targetNodeLabel,
