...
import {
  PalaceImportFooter,
} from '@/features/palace-edit/components/palace-import-drawer/footer'
import {
...
import {
  PalaceImportSourceConfigPanel,
} from '@/features/palace-edit/components/palace-import-drawer/source-config-panel'
import { countSourceTreeNodes } from '@/features/palace-edit/components/palace-import-drawer/source-tree'
import type {
...
} from '@/features/palace-edit/components/palace-import-drawer/types'
import {
...
export function PalaceMindMapImportDrawer(props: PalaceMindMapImportDrawerProps) {
  ...
  const sourceConfigModel: PalaceImportSourceConfigModel = {
  ...
  const resultsModel: PalaceImportResultsModel = {
    batchMeta: props.batchMeta,
    extractedText: props.extractedText,
    hasStreamProgress,
    importWarnings: props.importWarnings,
  ...
  const footerModel: PalaceImportFooterModel = {
    applying: props.applying,
            ...
            <div className="min-h-0 flex flex-1 flex-col xl:flex-row">
              <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                <div data-testid="mindmap-import-scroll-panel" className="min-h-0 flex-1 overflow-y-auto">
                  ...
                  <PalaceImportResultsPanel model={resultsModel} />
                </div>
