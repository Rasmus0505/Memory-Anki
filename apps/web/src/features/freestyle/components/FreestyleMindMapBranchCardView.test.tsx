...
vi.mock('@/entities/mindmap-document', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/entities/mindmap-document')>()
  return {
    ...actual,
...
vi.mock('@/entities/palace/api', () => ({ getPalaceEditorApi: apiMocks.getPalaceEditorApi }))
