...
Owns: questions, question sets, generation specifications, answer judgement.

Does not own: training sessions, progress, content structures.
...
Allowed business-module dependencies: memory_content. Imports must target the dependency's `public.py` or `contract` package.
