...
from memory_anki.modules.quiz.application import workspace_service as service
from memory_anki.modules.quiz.application.ai_dependencies import PalaceQuizAiDependencies
