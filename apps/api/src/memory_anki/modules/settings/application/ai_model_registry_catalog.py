...
SCENES: tuple[AiSceneDefinition, ...] = (
    ...
    AiSceneDefinition(
        ...
        label="单图全文识别",
        description="单图脑图导入阶段 A：识别页面全部文字。",
        category_key="vl",
    ...
    AiSceneDefinition(
        ...
        label="识别原文整理脑图",
        description="脑图导入阶段 B：按范围删多余内容并输出脑图 JSON。",
        category_key="llm",
