...
Owns: palaces, nodes, segments, mini palaces, mind-map documents.

Does not own: questions, learning progress, AI runs.
...
Allowed business-module dependencies: library. Imports must target the dependency's `public.py` or `contract` package.
