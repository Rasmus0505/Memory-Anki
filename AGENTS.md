...
- This is a private two-device Windows product. Never hard-code one machine's paths; runtime data belongs under `%LOCALAPPDATA%\MemoryAnki` or `MEMORY_ANKI_HOME`.
